...
#else
#define FILE_BUFFER_BASE 0x120600000L
#endif
#endif
...
void * josal_memcpy_nocache (void *dst, const void *src, int count)
{
	int len = count;
...
/*
 * newlib_stubs.c
 * the bellow code is just to build ref-code. customers will removed the bellow code bacuase they need a library which is related to the
