 ...
 ***********************************************************************
 * usb_tty.h
 * Generic header file for USB Device Drivers
 *
 ***********************************************************************/
#ifndef _USB_TTY_H
#define _USB_TTY_H
...
#if 1
static struct CH9_UsbDeviceDescriptor devSsDesc = {
	CH9_USB_DS_DEVICE,
	CH9_USB_DT_DEVICE,
...
static struct CH9_UsbDeviceDescriptor devHsDesc = {
	CH9_USB_DS_DEVICE,
	CH9_USB_DT_DEVICE,
...
static struct CH9_UsbConfigurationDescriptor confHsDesc = {
...
static struct CH9_UsbConfigurationDescriptor confSsDesc = {
	CH9_USB_DS_CONFIGURATION,
	CH9_USB_DT_CONFIGURATION,
	cpuToLe16(
		CH9_USB_DS_CONFIGURATION
		+ CH9_USB_DS_INTERFACE
		+ 2 * CH9_USB_DS_ENDPOINT
		+ 2 * CH9_USB_DS_SS_USB_ENDPOINT_COMPANION),
	1,
	1,
	0,
	CH9_USB_CONFIG_RESERVED | CH9_USB_CONFIG_SELF_POWERED,
...
/*usb super speed desciptor*/
static struct CH9_UsbEndpointDescriptor acm_ss_in_desc = {
	.bLength =      USB_DT_ENDPOINT_SIZE,
	.bDescriptorType =  CH9_USB_DT_ENDPOINT,
	.bEndpointAddress = BULK_EP_IN,
	.bmAttributes =     CH9_USB_EP_BULK,
	.wMaxPacketSize =   cpuToLe16(1024),
};

static struct CH9_UsbEndpointDescriptor acm_ss_out_desc = {
	.bLength =      USB_DT_ENDPOINT_SIZE,
	.bDescriptorType =  CH9_USB_DT_ENDPOINT,
	.bEndpointAddress = BULK_EP_OUT,
	.bmAttributes =     CH9_USB_EP_BULK,
...
static struct CH9_UsbSSEndpointCompanionDescriptor acm_ss_bulk_comp_desc = {
	.bLength =              sizeof(acm_ss_bulk_comp_desc),
	.bDescriptorType =      USB_DT_SS_ENDPOINT_COMP,
	.bMaxBurst       =      3,
};

static struct CH9_UsbSSEndpointCompanionDescriptor acm_ss_notify_comp_desc = {
	.bLength =              sizeof(acm_ss_bulk_comp_desc),
	.bDescriptorType =      USB_DT_SS_ENDPOINT_COMP,
	/*.bMaxBurst       =      3,*/
};
...
static struct CH9_UsbConfigurationDescriptor ConfDesc = {
...
static struct CH9_UsbBosDescriptor bosDesc = {
	CH9_USB_DS_BOS,
	CH9_USB_DT_BOS,
...
#if 1
static struct CH9_UsbSSDeviceCapabilityDescriptor capabilitySsDesc = {
	...
	1, /*<----what's that????????????????????, look in spec*/
	1, /* 4 us*/
	cpuToLe16(500) /* 512 us*/
};
#endif

static struct CH9_UsbCapabilityDescriptor capabilityExtDesc = {
...
static struct CH9_UsbDeviceQualifierDescriptor qualifierDesc = {
...
#define ACM_CTRL_OVERRUN    BIT(6)
#define ACM_CTRL_PARITY     BIT(5)
#define ACM_CTRL_FRAMING    BIT(4)
#define ACM_CTRL_RI     BIT(3)
#define ACM_CTRL_BRK        BIT(2)
#define ACM_CTRL_DSR        BIT(1)
#define ACM_CTRL_DCD        BIT(0)
};
