...
#define ALIGN_SIZE_32(x)	(((x) + 32 - 1) & ~(31))
...
#define CMD_BUF_ADDR  (BLK_BUF_ADDR + ALIGN_SIZE_32(BUF_SIZE))  // 512
#define CB0_BUF_ADDR  (CMD_BUF_ADDR + ALIGN_SIZE_32(BUF_SIZE))  // 128
#define CB1_BUF_ADDR  (CB0_BUF_ADDR + ALIGN_SIZE_32(CB_SIZE))   // 128
#define CB2_BUF_ADDR  (CB1_BUF_ADDR + ALIGN_SIZE_32(CB_SIZE))   // 128
#define EP0_BUF_ADDR  (CB2_BUF_ADDR + ALIGN_SIZE_32(CB_SIZE))   // 64
#define RSP_BUF_ADDR  (EP0_BUF_ADDR + ALIGN_SIZE_32(EP0_SIZE))  // 32
#define ACM_BUF_ADDR  (RSP_BUF_ADDR + ALIGN_SIZE_32(RSP_SIZE))  // 128
#define STP_BUF_ADDR  (ACM_BUF_ADDR + ALIGN_SIZE_32(ACM_SIZE))  // 32
#define HANDLER_ADDR  (STP_BUF_ADDR + ALIGN_SIZE_32(STP_SIZE))  // 1024
