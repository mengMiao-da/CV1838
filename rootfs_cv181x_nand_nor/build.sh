...
python3 /home/cx/work/project/CV181X/v4.1.0_source/build/tools/common/spinand_tool/mkubiimg.py --ubionly partition_spinand_page_2k.xml ROOTFS ./rootfs.su rootfs.bin -b 131072 -p 2048
